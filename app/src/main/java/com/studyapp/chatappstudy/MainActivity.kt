package com.studyapp.chatappstudy
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        queryEdt.setOnEditorActionListener(OnEditorActionListener { v, actionId, event ->
            if (actionId == EditorInfo.IME_ACTION_SEND) {
                ...
                responseTV.text = "잠시만 기다려봐유.. 후딱 답해줄랑께"
                responseTV.setTextColor(Color.YELLOW)
                // validating text
            ...
            object : JsonObjectRequest(Method.POST, url, jsonObject,
                ...
                override fun getHeaders(): kotlin.collections.MutableMap<kotlin.String, kotlin.String> {
                    ...
                    params["Authorization"] =
                        "Bearer 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"
                    return params;
                }
            }
